                ...
                <div>
                    ...
                    <div className="footer">
                        <div className="footerRow">
                            <a className="alignTextLeft"
                               href={this.props.newsItem.url}>{this.extractDomainFromUrl(this.props.newsItem.url)}</a>
                            <div>
                        ...
                        <div className="footerRow">
                            <div className="comments">
                                ...
                                <div><a
                                    href={"https://news.ycombinator.com/item?id=" + this.props.newsItem.id}>{this.props.newsItem.kids === undefined ? 0 : this.props.newsItem.kids.length} comments</a>
                                </div>
                            </div>
                            <div>
